...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_6]  = ACTION_TAP_DANCE_DOUBLE(KC_RALT, KC_RCTRL),
    [TD_7]  = ACTION_TAP_DANCE_DOUBLE(KC_MINUS, KC_EQUAL),
    [TD_8]  = ACTION_TAP_DANCE_DOUBLE(KC_BSPACE, KC_DELETE),
    [TD_9]  = ACTION_TAP_DANCE_DOUBLE(KC_SLASH, KC_BSLASH),
    [TD_10] = ACTION_TAP_DANCE_DOUBLE(KC_LBRACKET, KC_RBRACKET),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // Row 1
       KC_LCTRL, KC_A, KC_S, KC_D, LT(1, KC_F), KC_G,    KC_H, KC_J, KC_K, KC_L, KC_SCOLON, KC_QUOTE,
  // Row 2
       KC_LALT, TD(TD_1), TD(TD_2), TD(TD_3), TD(TD_4), KC_B,    KC_N, KC_M, KC_COMMA, KC_DOT, TD(TD_9), TD(TD_6),
  // Thumb keys (Left: 3, Right: 2)
                                  KC_LSHIFT, KC_ENTER, MO(3),    TD(TD_8), LT(2, KC_SPACE)
  ),
  ...
  // Row 1
       _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    KC_HOME, XXXXXXX, KC_UP, XXXXXXX, KC_PGUP, KC_PSCREEN,
  // Row 2
       _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    KC_END, KC_LEFT, KC_DOWN, KC_RIGHT, KC_PGDOWN, XXXXXXX,
  // Thumb keys (Left: 3, Right: 2)
  ...
  [2] = LAYOUT(
  // Row 0
       KC_GESC, KC_1, KC_2, KC_3, KC_4, KC_5,    KC_6, KC_7, KC_8, KC_9, KC_0, TD(TD_7),
  // Row 1
       _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX, KC_KP_4, KC_KP_5, KC_KP_6, XXXXXXX, XXXXXXX,
  // Row 2
       _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    KC_KP_0, KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_DOT, KC_NUMLOCK,
  // Thumb keys (Left: 3, Right: 2)
                                  _______, _______, _______,    _______, _______
  ),
